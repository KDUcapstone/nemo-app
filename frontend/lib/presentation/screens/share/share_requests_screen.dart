                  ...
                  : RefreshIndicator(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (_, i) {
                          ...
                          final inviter = (it['invitedBy'] as Map?)?['nickname']?.toString() ?? '친구';
                          final role = (it['inviteRole']?.toString() ?? 'VIEWER').toUpperCase();
                          String roleKo;
                          switch (role) {
                            case 'OWNER':
                              roleKo = '소유주';
                          ...
                          final when = invitedAt != null
                              ? DateFormat('MM/dd HH:mm').format(DateTime.parse(invitedAt).toLocal())
                              : '';
                          return ListTile(
