...
class _QrScannerScreenState extends State<QrScannerScreen>
  ...
  Future<void> _toggleTorch() async {
    if (_isDisposed || _isSwitching || _isClosing || _controller == null)
      return;
    try {
  ...
  Future<void> _switchCamera() async {
    if (_isDisposed || _isClosing || _controller == null) return;
    try {
      _isSwitching = true;
  ...
  void _onDetect(BarcodeCapture capture) {
    if (_isHandling || _isSwitching || _isClosing) return;
